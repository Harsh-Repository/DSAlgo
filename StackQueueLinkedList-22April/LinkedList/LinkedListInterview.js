//In this exercise, we will see how check if a value is in a linked list using the two pointer method.
//This method approaches the contains problem similar to the palindrome problem.
//We set a pointer to the rear of the list and one to the front of the list.
//We iterate checking each pointer to the value we want to search for. If we find it, we return true, and if we do not, we return false.
